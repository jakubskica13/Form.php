  ...
  <div id="header"><img src="img/ph-header2.png" width="739"
    ...
    <div id="mainContent">
      ...
      <form action="form-action.php" method="post" name="signup" id="signup">
        ...
        <p>
          What do you read?
          <br><label><input name="publications[]" type="Checkbox" id="publications_drif" value="BuzzFeed"> BuzzFeed</label>
          <br><label><input name="publications[]" type="Checkbox" id="publications_elle" value="Reddit"> Reddit</label>
        </p>
        <p>
          Fun Stuff:<br>

        <select name="howoftentrack" id="comments" cols="52" rows="5">
        ...
        <p>Tell us about yourself!<br>
          <textarea name="comments" id="comments" cols="52" row=5>
          </textarea>
        </p>
